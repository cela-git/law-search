...
인증서(PKI) | 개인키의 안전한 보관 필요(안전한 보안매체에 보관 권고)
OTP
OTP토큰, 모바일OTP 등 다양한 방식 존재
소유 기반 | (One Time Password)
스마트 카드 방식
기타
물리적 보안토큰 방식 등
생체인식정보의 안전한 관리 필요
...
IP주소 방식
기타 방식
(사용자 | 단말기의 MAC주소를 기반으로 등록된 단말기에서만
MAC주소
인증의 | 접속할 수 있도록 제한하는 방식
보완통제로 | 특정 PC 또는 특정 디바이스(스마트폰 등)에서만 접속할 수
기기 일련번호
적용 가능) | 있도록 제한하는 방식
기타 | 위치정보를 기반으로 접속을 제한하는 방식 등
▶ 계정 도용 및 불법적인 인증시도 통제방안 예시
구 분 | 설명
인증 실패횟수 | 일정 횟수 이상 인증에 실패한 경우 접근 제한
제한 | ※ 개인정보의 안전성 확보조치 기준 제5조제6항
접속 후 일정시간 이상 업무처리를 하지 않은 경우 자동으로 접속 차단
접속 유지시간 (Session Timeout 또는 Idle Timeout 등) 제한
...
대상 | 이용자가 아닌 정보주체의 개인정보를 | 이용자의 개인정보를 처리하는
개인정보처리시스템 | 처리하는 개인정보처리시스템 | 개인정보처리시스템
안전한 접속수단 또는 안전한 인증수단 적용
적용 필요 사항 | 안전한 인증수단 적용
...
변경주기 설정 변경주기는 위험평가 결과 등을 고려하여 자체적으로 결정)
동일한 문자 반복, 키보드 상에서 나란히 있는 문자열, 일련번호, 연속적인
추측하기 쉬운 숫자, 생일, 전화번호 등 추측하기 쉬운 개인정보 및 ID와 비슷한 비밀번호
비밀번호 설정 제한 사용 제한 동일한 비밀번호
...
▶ 암호화 대상 : 법적 요구사항, 처리 정보 민감도 및 중요도에 따라 정의 개인정보 보호법에 따른 암호화 대상 개인정보 구분
이용자가 아닌 정보주체의 개인정보 | 이용자의 개인정보
정보통신망을 | 정보통신망 | 인증정보(비밀번호, 생체인식정보 등)
통한 개인정보 인터넷망
송·수신 시
※ 단, 종전의 개인정보의 안전성 확보조치 기준 적용대상의 경우 2024.9.15 시행 인증정보(비밀번호, 생체인식정보 등)
저장 위치 | ※ 단, 비밀번호는 일방향암호화
무관 | 주민등록번호
※ 법 제24조의2 제2항에 따라 암호화
인터넷구간,
고유식별정보 | 주민등록번호,
저장 시 DMZ 여권번호, 운전면허번호,
※ 단, 주민등록번호 외의 고유식별정보를 | 외국인등록번호,
내부망에 저장하는 경우에는 개인정보 신용카드번호, 계좌번호,
...
저장 시 | 2. 해당 정보를 암호화한 후 보조저장매체에 저장 등
...
▶ 개인정보처리시스템 접속기록 보존기간
구분 | 보존 기간
5만명 이상의 정보주체에 관한 개인정보를 처리하는 개인정보처리시스템에 해당하는 경우 고유식별정보 또는 민감정보를 처리하는
...
▶ 클라우드 서비스 유형에 따른 역할 및 책임(예시) 클라우드
...
IaaS | 관리 등 | 사설 네트워크 영역에 대한 보안 구성 및
설정
데이터 보안
관리자, 사용자 권한 관리 등
...
※ 통지 사항 중 1호, 2호 사항에 관한 구체적인 내용을 확인하지 못한 경우에는 개인정보가 유출된 사실, 그때까지 확인된 내용 및 같은 항 제3호부터 제5호까지의 사항을 서면등의 방법으로 우선 통지해야 하며, 추가로 확인되는 내용에 대해서는 확인되는 즉시 통지
...
신고 대상 외부로부터의 불법적인 접근에 의해 개인정보가 유출등이 된 경우
...
다만, 법 제17조제2항제1호부터 제4호까지의 사항에 대하여 같은 조 제1항제1호에 따라 정보주체의 동의를 받은 범위에서 연 2회 이상
통지 시기 주기적으로 개인정보를 제공받아 처리하는 경우에는 개인정보를 제공받은 날부터 3개월 이내에 정보주체에게 알리거나 그 동의를 받은 날부터 기산하여 연 1회 이상 정보주체에게 알려야 함
구분 | 내용
...
3 | ○ | ○
필요하다고 인정되는 경우 개인정보를 목적 외의 용도로 이용하거나 이를 제3자에게 제공하지
4 | 않으면 다른 법률에서 정하는 소관 업무를 수행할 수 없는 경우로서 | ○ | -
개인정보 보호위원회의 심의·의결을 거친 경우 조약, 그 밖의 국제협정의 이행을 위하여 외국정부 또는 국제기구에
5 | ○ | -
제공하기 위하여 필요한 경우
...
가명처리 대상 데이터의 위험성 검토
처리 대상의
2 | ① 데이터 자체 식별 위험성 : 식별정보, 식별가능정보, 특이정보, 재식별 시 영향도 등
위험성 검토 ② 처리 환경 식별 위험성 : 활용 형태(내부 활용, 외부 제공, 외부 결합 등), 처리 장소, 처리 방법
...
가명처리 적정성 검토는 내부 인원을 활용하여 자체적으로 검토하거나, 외부 전문가를 통하여 검토 가능(단, 최소 3명 이상으로 검토위원회를 구성하는
4 | 적정성 검토
것을 권고)
...
단계 | 구분 | 설명
결합신청자는 신청자 간 결합신청에 필요한 사항의 협의, 결합신청서 작성 등 가명정보 결합에 필요한 사전 준비사항을 확인하고 결합전문기관에 결합을
1 | 결합신청
신청
...
정보주체가 전송을 요구하는 정보가 정보주체 본인에 관한 개인정보로서 다음 각 목의 어느 하나에 해당하는 정보일 것
...
다. 제15조제1항제2호, 같은 항 제3호, 제23조제1항제2호 또는 제24조제1항제2호에 따라 처리되는 개인정보 중 정보주체의 이익이나 공익적 목적을 위하여 관계 중앙행정기관의 장의 요청에 따라 보호위원회가 심의·의결하여 전송 요구의 대상으로 지정한 개인정보 전송을 요구하는 개인정보가 개인정보처리자가 수집한 개인정보를 기초로 분석·가공하여 별도로
2 생성한 정보가 아닐 것
...
통지 의무 | 2. 100만명 이상의 정보주체에 관하여 개인정보를 처리하는 자
대상자
...
통지 방법 알리는 방법(법 제20조의2제1항에 따른 개인정보의 이용·제공 내역을 확인할 수 있는 정보시스템에 접속하는 방법을 통지하는 경우로 한정한다)
통지 주기 | 연 1회 이상
